...
public class PercentLayout extends RelativeLayout {
    ...
    public static class LayoutParams extends RelativeLayout.LayoutParams {
        ...
        LayoutParams(Context c, AttributeSet attrs) {
            ...
            widthPercent = a.getFloat(R.styleable.PercentLayout_widthPercentR, 0);
            heightPercent = a.getFloat(R.styleable.PercentLayout_heightPercentR, 0);
            marginLeftPercent = a.getFloat(R.styleable.PercentLayout_marginLeftPercentR, 0);
            marginRightPercent = a.getFloat(R.styleable.PercentLayout_marginRightPercentR, 0);
            marginTopPercent = a.getFloat(R.styleable.PercentLayout_marginTopPercentR, 0);
            marginBottomPercent = a.getFloat(R.styleable.PercentLayout_marginBottomPercentR, 0);
            a.recycle();
        }
    }
}
